...
void inOrderTraversalIterative(Node* root,stack<Node*> sta)
{
	do
	{
		while (root)
...
{
    stack<Node*> sta;
    inOrderTraversalIterative(root, sta);
}
...
int main(void)
{
	Node* root = new Node(1,new Node(2,new Node(4,new Node(8,NULL,NULL),new Node(9,NULL,NULL)),new Node(5,new Node(10,NULL,NULL),new Node(11,NULL,NULL))),new Node(3,new Node(6,new Node(12,NULL,NULL),new Node(13,NULL,NULL)),new Node(7,NULL,NULL)));
